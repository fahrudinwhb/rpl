      ...
      <div class="container">
        <ul class="nav navbar-nav">
                        ...
                        <li role="presentation" class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active"><a href="<?php echo base_url() ?>index.php/beranda/ikanlaut">Ikan Laut</a></li>
             ...
             <div class="grid">
                <?php foreach ($data as $value) { ?>
                 <figure class="effect-dexter">
						<img src="<?php echo base_url(); ?>images/<?php echo $value['fotoikan'] ?>">
						<figcaption>
							<h2>Ikan Tenggiri</h2>
							<p>Dexter had his own strange way. You could watch him training ants.</p>
							<a href="<?php echo site_url() ?>/control_beranda/GetDetailIkan/<?php echo $value['id_ikan'] ?>">View more</a>
						</figcaption>			
					</figure>
            <?php } ?>
             </div>
