    ...
    <nav class="navbar navbar-default" style="background-color:#ecf0f1; width:100%; padding:10px; margin:0px;">
      <div class="container">
        <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="<?php echo base_url() ?>index.php/beranda/hubungikami">Hubungi Kami</a></li>
                ...
                <div class="third-content-a">
                    ...
                    <div class="mencakup">
                        <div class="one-four-us" >
                            <i class="flaticon-website17"></i> 
                            <div class="tulisanin">WEBSITE:<br><a href="Home.php">www.fish-i.com</a><br></div>
                        </div>
                        <div class="two-four-us">
                            <i class="flaticon-facebook29"></i>
                            <br>FACEBOOK:<br><a href="#">Http:facebook.com/fish-i</a><br>
                        </div>
                        <div class="three-four-us">
                            <i class="flaticon-mail59"></i>
                            <br>EMAIL:<br><a href="##">fish-i@gmail.com</a><br>
                        </div>
                        ...
                        <form action="" method="post" class="formbawah">
                            <table id="concol">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea type="text" name="kritiksaran" class="kirimin" placeholder="Isi kritik dan saran anda"></textarea>
                                    </td>
                                </tr>
                            </table>
