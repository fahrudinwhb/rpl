            ...
            <div class="right-content">
                ...
                <div class="content">
                    ...
                    <ul>
                        ...
                        <li><i class="fa fa-clock-o"></i><p>Jenis_Ikan</p><div><?php echo $jenis ?></div>
                        </li>
                    </ul>
...
<!--Komentar-->
                   <?php foreach ($komentar as $komen) { ?>
                    <div class ="container div-rev">
                    <div class="col-xs-1">
                        <div class="image-crop">
                            <img src="#" alt="foto" class="profile-pic">
                        </div>
                    </div>
                    <div class="col-xs-3">
                        <p class="text"><?php echo $komen['username']; ?></p><br>
                    <p class="text2"><?php echo $komen['isi_komentar']; ?></p>
                    </div>
                    <div class="col-xs-3 col-xs-offset-5">
                    </p><?php echo $komen['tanggal_komentar']; ?>
                    </div>
                    </div>
